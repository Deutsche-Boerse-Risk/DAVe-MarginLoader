...
docker tag dbgdave/dave-margin-loader:${CIRCLE_SHA1} docker.io/dbgdave/dave-margin-loader:${CIRCLE_SHA1}
docker push dbgdave/dave-margin-loader:${CIRCLE_SHA1}
docker tag dbgdave/dave-margin-loader:${CIRCLE_SHA1} docker.io/dbgdave/dave-margin-loader:${CIRCLE_BRANCH}
